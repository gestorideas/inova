...
$(function () {
 $( "input,textarea" ).jqBootstrapValidation ( {
    ...
    event.preventDefault (); // Evade el comportamiento normal del formulario
       ...
       var txtidIdea = $( "input#txtidIdea" ).val();
       ...
       $.ajax ( {
                url: "../controller/controllerEditIdea.php",
                type: "POST",
                data: { txtidIdea: txtidIdea, txtIdea: txtIdea, txtIdeaDescription: txtIdeaDescription, txtIdeasTags: txtIdeasTags },
                cache: false,
